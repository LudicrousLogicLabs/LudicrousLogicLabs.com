...
const Card: React.FC<React.PropsWithChildren<CardProps>> = ({ image, title, description }) => {
  return (
    <div className="flex basis-0 grow flex-col border-solid border-slate-400 rounded-lg px-7 py-10 border-2">
        <img src={image} className="h-16 w-16 mx-auto rounded-[50%] overflow-visible bg-slate-300 p-4" />
